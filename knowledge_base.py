KNOWN_ISSUES = [
    ...
    {
        "category": "Rete e connettivita'",
        "title": "Fully Kiosk o sensore REST non raggiungibile",
        "patterns": ["fully_kiosk", "192.168.1.55:2323", "timeout while fetching data"],
        "diagnosis": "Il tablet/Fully Kiosk o un endpoint REST locale non risponde sulla LAN.",
        "safe_response": "Solo notifica: verificare alimentazione, API remota Fully, password/porta e prenotazione DHCP.",
        "automation_level": "manual",
    },
    {
        "category": "Camera e stream",
        "title": "Camera ONVIF non raggiungibile",
        "patterns": ["onvif", "event_service", "connect call failed", "timed out"],
        "diagnosis": "Home Assistant non riesce a rinnovare o ricreare la subscription eventi ONVIF della camera.",
        "safe_response": "Solo notifica: verificare IP/porta ONVIF, alimentazione e rete; reload mirato solo quando si conosce il config entry.",
        "automation_level": "manual",
    },
    {
        "category": "LocalTuya",
        "title": "Sirena LocalTuya senza state_on",
        "patterns": ["localtuya", "keyerror: 'state_on'", "conf_state_on"],
        "diagnosis": "Una entita' siren LocalTuya ha una configurazione incompleta e manca il valore state_on usato per interpretare lo stato.",
        "safe_response": "Solo notifica: completare state_on/state_off nella config LocalTuya o ricreare la sirena con datapoint corretti.",
        "automation_level": "manual",
    },
    {
        "category": "Integrazioni cloud",
        "title": "Blink o DNS cloud non raggiungibile",
        "patterns": ["blinkpy", "timeout while contacting dns servers", "tokenrefreshfailed", "login endpoint failed"],
        "diagnosis": "Blink non riesce a contattare i servizi cloud o a rinnovare il token, spesso per DNS/gateway o temporaneo cloud outage.",
        "safe_response": "Solo notifica: verificare DNS/gateway host e poi, se isolato a Blink, rifare reauth.",
        "automation_level": "manual",
    },
    {
        "category": "Integrazioni cloud",
