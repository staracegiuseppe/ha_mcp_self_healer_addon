...
export ALLOW_AUTOMATION_RESTART="$(get_opt allow_automation_restart true)"
...
export ALLOW_MQTT_STATE_PATCH="$(get_opt allow_mqtt_state_patch true)"
export ALLOW_UPDATE_INSTALL="$(get_opt allow_update_install true)"
export MAX_ACTIONS_PER_CYCLE="$(get_opt max_actions_per_cycle 10)"
